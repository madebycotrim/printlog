    ...
    return (
        ...
        `}>
            ...
            <nav className="flex-1 py-2 overflow-y-auto custom-scrollbar relative z-10 space-y-1">
                ...
                <SidebarItem href="/clientes" icon={Users} label="Clientes" collapsed={collapsed} color="sky" />

                <SidebarSection title="Gestão" collapsed={collapsed} />
                <SidebarItem href="/filamentos" icon={Package} label="Filamentos" collapsed={collapsed} badge={alerts.lowStock} color="rose" />
                <SidebarItem href="/insumos" icon={Layers} label="Insumos" collapsed={collapsed} color="orange" />
                ...
                <SidebarItem href="/projetos" icon={FolderOpen} label="Projetos" collapsed={collapsed} color="amber" />
                <SidebarItem href="/financeiro" icon={Wallet} label="Financeiro" collapsed={collapsed} color="emerald" />
