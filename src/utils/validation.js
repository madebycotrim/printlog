...
// ========================================
// VALIDAÇÃO RIGOROSA DE INPUTS (FRONTEND)
// Espelho da lógica do Backend (_validation.js)
// ========================================
...
export const schemas = {
    ...
    printer: {
        ...
        historico: { type: 'object' } // Arrays são objetos em JS
    },
 ...
 * @param {Object} schema - Schema de validação (ex: schemas.filament)
...
/**
 * Remove campos não permitidos do objeto (previne poluição)
