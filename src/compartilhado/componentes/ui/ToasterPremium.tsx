    ...
    <Toaster
      ...
      toastOptions={{
        ...
        classNames: {
          ...
          content: '!ml-2',
          closeButton: '!border !border-zinc-200 dark:!border-white/10 !bg-white/90 dark:!bg-zinc-800/90 !text-zinc-600 dark:!text-zinc-300 hover:!bg-zinc-100 dark:hover:!bg-zinc-700 !transition-colors',
