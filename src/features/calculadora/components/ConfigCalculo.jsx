            ...
            <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                    <div className="flex items-center gap-1.5">
                        ...
                        {textoAjuda && <Tooltip text={textoAjuda} />}
                    </div>
                </div>
            </div>
...
export default function PainelConfiguracoesCalculo({ onSaved, onOpenTaxas }) {
        ...
        <div className="relative h-full flex flex-col">
            <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-right-4 duration-500 pb-10">
                ...
                <div className="flex items-center justify-between pb-4 border-b border-zinc-800/50">
                    <div className="flex flex-col">
                        <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-500 mb-1">Sincronização</span>
                        <div className="flex items-center gap-2">
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-zinc-950/40/20 border border-zinc-800/30 rounded-2xl p-4 space-y-3">
                        ...
                        <div className="grid grid-cols-1 gap-3">
                            ...
                            />
                            <EntradaConfiguracao
                                rotulo="Custo kWh" sufixo="R$/kWh" icone={Zap} cor="text-amber-400"
                    ...
                    <div className="bg-zinc-950/40/20 border border-zinc-800/30 rounded-2xl p-4 space-y-3">
                        ...
                        <div className="grid grid-cols-1 gap-3">
                            <EntradaConfiguracao
                                rotulo="Depreciação/Manut." sufixo="R$/h" icone={Cpu} cor="text-blue-400"
                                valor={custoHoraMaquina} aoAlterar={lidarMudancaInput(setCustoHoraMaquina)}
                                textoAjuda="Custo de depreciação e peças por hora."
                            />
                            <EntradaConfiguracao
                                rotulo="Taxa de Inicialização" sufixo="R$" icone={Settings2} cor="text-zinc-400"
                    ...
                    <div className="bg-zinc-950/40/20 border border-zinc-800/30 rounded-2xl p-4 space-y-3">
                        ...
                        <EntradaConfiguracao
                            rotulo="Preço da Hora" sufixo="R$/h" icone={User} cor="text-emerald-400"
                ...
                <div className="bg-zinc-950/40/20 border border-zinc-800/30 rounded-2xl p-4 space-y-3">
                    <div className="flex items-center gap-2 pb-1">
                        ...
                        <h4 className="text-[10px] font-black text-zinc-400 uppercase tracking-widest">Taxas de Venda</h4>
                    </div>
                    <button
                        onClick={onOpenTaxas}
                        className="w-full group flex items-center justify-between p-3 rounded-2xl bg-zinc-950/40 border border-zinc-800/50 hover:border-amber-500/50 hover:bg-amber-500/5 transition-all duration-300"
                    >
                        <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-xl bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-amber-500 shadow-inner group-hover:scale-110 transition-transform">
                                <Store size={14} strokeWidth={2.5} />
                            </div>
                            <div className="flex flex-col text-left">
                                <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-tight group-hover:text-amber-400 transition-colors">Gerenciar Canais de Venda</span>
                                <span className="text-[8px] text-zinc-600 font-bold uppercase tracking-widest">Configurar taxas salvas</span>
                            </div>
                        </div>
                        <Settings2 size={14} className="text-zinc-700 group-hover:text-amber-500 transition-colors" />
                    </button>
                </div>
            </div>
