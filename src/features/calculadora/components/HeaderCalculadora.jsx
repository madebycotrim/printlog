...
import { Printer, History, Settings2, ChevronDown, Trash2, FileCode, UserCircle2 } from "lucide-react";
        ...
        <header className="px-8 xl:px-12 py-8 flex items-start justify-between z-40 relative shrink-0 gap-6">
            ...
            <div className="flex flex-col min-w-[200px] max-w-xl group relative">
                ...
                <div className="mt-4 flex items-center gap-2 relative z-30">
                    ...
                    <select
                        ...
                        className="bg-transparent text-sm font-medium text-zinc-400 hover:text-zinc-200 focus:text-sky-400 outline-none cursor-pointer transition-colors border-b border-transparent focus:border-sky-500/50 pb-0.5 appearance-none min-w-[150px]"
                    >
                        <option value="" className="bg-zinc-900 text-zinc-500">Cliente (Opcional)</option>
            ...
            <div className="flex items-center gap-4 shrink-0 pt-1">
                ...
                <button
                    ...
                    className="group flex items-center gap-3 px-4 py-3 bg-zinc-900/50 border border-zinc-800/50 hover:border-zinc-800/50 hover:bg-zinc-950/40 rounded-2xl transition-all duration-300 hover-lift"
                >
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        title="Configurações"
                        className={`w-12 h-12 rounded-xl bg-zinc-900/50 border border-zinc-800/50 flex items-center justify-center transition-all hover-lift ${needsConfig ? 'text-amber-500 border-amber-500/30 animate-pulse' : 'text-zinc-500 hover:text-white hover:border-zinc-800/30'}`}
                    >
                        <Settings2 size={18} />
                    </button>
                    <button
