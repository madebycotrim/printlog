...
import {
    ...
    ExternalLink, Printer, AlertTriangle
} from "lucide-react";
import { formatCurrency, formatDecimal } from "../../../utils/numbers";
import Popup from "../../../components/Popup";
import { CONFIG_STATUS } from "../../../pages/projetos";
    ...
    return (
        <div className="fixed inset-0 z-[100] flex justify-end bg-black/80 backdrop-blur-sm animate-in fade-in duration-300">
            ...
            <div className="
                ...
                {/* HEADER */}
                <div className="p-8 border-b border-white/5 bg-zinc-950/40/20 shrink-0">
                    <div className="flex justify-between items-start mb-6">
                        ...
                        <button onClick={onClose} className="p-3 bg-zinc-950/40 hover:bg-zinc-900/50 rounded-xl text-zinc-500 transition-all border border-white/5 group">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        ...
                        <div className="bg-zinc-900/50 p-3 rounded-xl border border-white/5">
                            ...
                            <span className="text-sm font-mono font-black text-zinc-300 italic">{formatDecimal(pesoTotalCalculado, 0)}g</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex-1 overflow-y-auto p-8 space-y-8 custom-scrollbar bg-gradient-to-b from-transparent to-black/20">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="bg-zinc-950/40/30 p-5 rounded-2xl border border-white/5">
                ...
                {/* FOOTER */}
                <div className="p-8 border-t border-white/5 bg-zinc-950/40/40 space-y-4">
                    <div className="grid grid-cols-2 gap-3">
                        <button className="h-12 bg-zinc-950/40 hover:bg-zinc-900/50 text-zinc-400 rounded-xl font-black text-[9px] uppercase tracking-widest flex items-center justify-center gap-2 transition-all border border-white/5 active:scale-95">
