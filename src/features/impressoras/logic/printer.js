// src/features/impressoras/logic/printer.js
...
export const usePrinterStore = create((set, get) => ({
    ...
    fetchPrinterModels: async () => {
        ...
        try {
            const resposta = await api.get('/printers.json', { baseURL: '/' });
    ...
    fetchPrinters: async () => {
        ...
        try {
            ...
            useToastStore.getState().addToast("Erro ao carregar impressoras.", "error");
    ...
    upsertPrinter: async (dados) => {
        try {
            ...
            useToastStore.getState().addToast("Impressora salva com sucesso!", "success");
            return true;
        } catch (erro) {
            console.error("Erro ao salvar impressora:", erro);
            useToastStore.getState().addToast("Erro ao salvar impressora.", "error");
            throw erro;
        }
    },
    ...
    removePrinter: async (id) => {
        try {
            ...
            useToastStore.getState().addToast("Impressora removida.", "success");
        } catch (erro) {
            console.error("Erro ao remover impressora:", erro);
            useToastStore.getState().addToast("Erro ao remover impressora.", "error");
            throw erro;
        }
    },
    ...
    updatePrinterStatus: async (id, novoStatus) => {
        ...
        if (impressora) {
            try {
                ...
                useToastStore.getState().addToast(`Status alterado para ${novoStatus}`, "success");
            } catch (erro) {
