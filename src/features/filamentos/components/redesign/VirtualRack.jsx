    ...
    return (
        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-150">
            {Object.entries(groupedFilaments).map(([material, items]) => (
                <div key={material} className="relative group/shelf">
                    ...
                    {viewMode === 'grid' ? (
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-6">
                            ...
                            <button
                                ...
                                className="group flex flex-col items-center justify-center min-h-[320px] rounded-3xl border-2 border-dashed border-zinc-800 hover:border-zinc-700 bg-transparent hover:bg-zinc-900/30 transition-all duration-300"
                            >
                                <div className="w-12 h-12 rounded-full bg-zinc-900 flex items-center justify-center group-hover:scale-110 transition-transform duration-300 border border-zinc-800 group-hover:border-zinc-600">
                                    <Plus size={24} className="text-zinc-600 group-hover:text-zinc-300" />
                                </div>
