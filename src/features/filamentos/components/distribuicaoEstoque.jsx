        ...
        <div className="group relative h-[150px] p-5 rounded-2xl bg-[#09090b] border border-zinc-800/50 overflow-hidden flex flex-col justify-between transition-all hover:border-zinc-700/60 shadow-2xl">
            ...
            <div className="relative z-10 flex justify-between items-start">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-widest leading-none mb-1">Tipos de Material</p>
                        <h3 className="text-sm font-bold text-zinc-300 flex items-center gap-1.5 uppercase tracking-tighter">
                            {materialDominante ? (
                                <>
                                    <Layers size={12} className="text-sky-500" />
                                    Maioria: {materialDominante.type}
                                </>
                            ) : "Nenhum dado"}
                        </h3>
                    </div>
                ...
                <div className="text-right">
                    <span className="text-[10px] font-bold text-zinc-600 uppercase bg-zinc-900/50 px-2 py-0.5 rounded border border-zinc-800/50">
                        {stats.length} Categorias
                    </span>
                </div>
            </div>
            ...
            <div className="relative z-10 space-y-2">
                ...
                <div className="flex items-center gap-4">
                    ...
                    {/* BADGE DE OUTROS */}
                    {othersCount > 0 && (
                        <div className="flex items-center gap-1 text-[8px] font-bold text-zinc-600 uppercase bg-zinc-900/80 px-1.5 py-0.5 rounded border border-zinc-800/50">
            ...
            <div className="relative z-10 pt-2 border-t border-white/5 flex justify-between items-center">
                <span className="text-[8px] text-zinc-600 font-bold uppercase tracking-widest">Resumo do Estoque</span>
