                ...
                <div className="w-full md:w-[280px] bg-black/40 border-b md:border-b-0 md:border-r border-zinc-800/60 p-6 flex flex-col items-center justify-between shrink-0">
                    ...
                    <div className="relative z-10 w-full">
                        <div className="flex items-center gap-2 mb-4 justify-center">
                            ...
                            <span className="text-[8px] font-bold text-zinc-500 uppercase tracking-[0.2em]">Preview do Rolo</span>
                        </div>
                    ...
                    <div className="relative z-10 w-full space-y-4">
                        <div className="text-center">
                            <h3 className="text-base font-bold text-white uppercase truncate mb-1">{item.name || "Sem nome"}</h3>
                            <div className="flex items-center justify-center gap-2">
                                <span className="text-[7px] font-bold bg-zinc-900 text-zinc-500 border border-zinc-800 px-1.5 py-0.5 rounded uppercase">
                                    {item.brand}
                                </span>
                                <span className="text-[7px] font-bold bg-amber-500/10 text-amber-500 border border-amber-500/20 px-1.5 py-0.5 rounded uppercase">
                ...
                <div className="flex-1 flex flex-col">
                    ...
                    <header className="px-6 py-4 border-b border-white/5 bg-zinc-900/20 flex justify-between items-center">
                        <div className="flex items-center gap-3">
                            ...
                            <h3 className="text-[10px] font-bold text-white uppercase tracking-widest">Gastar Filamento</h3>
                        </div>
                    ...
                    <div className="p-8 overflow-y-auto custom-scrollbar flex-1 space-y-8">
                        ...
                        {/* PASSO 01: QUANTO USOU */}
                        <section className="space-y-4">
                            <div className="flex items-center gap-3">
                                <span className="text-[10px] font-bold text-sky-500 font-mono">[ 01 ]</span>
                                <h4 className="text-[9px] font-bold text-zinc-400 uppercase tracking-widest">Quanto você usou?</h4>
                            ...
                            <div className="grid grid-cols-4 gap-2">
                                {[10, 50, 100, 250].map(val => (
                                    <button
                                        ...
                                        className="py-2 bg-zinc-900/50 border border-zinc-800 hover:border-zinc-600 text-[10px] font-bold text-zinc-500 hover:text-zinc-100 rounded-lg transition-all"
                                    >
                                        +{val}g
                                    </button>
                                ))}
                        ...
                        {/* PASSO 02: COMO VAI FICAR */}
                        <section className="space-y-4">
                            <div className="flex items-center gap-3">
                                <span className="text-[10px] font-bold text-emerald-500 font-mono">[ 02 ]</span>
                                <h4 className="text-[9px] font-bold text-zinc-400 uppercase tracking-widest">Como vai ficar</h4>
                                <div className="h-px bg-zinc-800/50 flex-1" />
                            </div>
                            ...
                            <div className="p-4 bg-zinc-900/20 border border-zinc-800/60 rounded-xl space-y-4">
                                <div className="flex justify-between items-end">
                                    <div>
                                        <p className="text-[7px] font-bold text-zinc-600 uppercase tracking-widest mb-1">Peso restante no rolo</p>
                                    ...
                                    {erroSaldo && (
                                        <div className="flex items-center gap-1.5 text-rose-500 animate-pulse mb-1">
                                            ...
                                            <span className="text-[8px] font-bold uppercase">Valor maior que o estoque!</span>
                                        </div>
                                    )}
                                </div>
