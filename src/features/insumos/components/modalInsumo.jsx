...
export default function ModalInsumo({ isOpen, onClose, editingItem }) {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-zinc-950/90 backdrop-blur-sm modal-backdrop">
            ...
            <div className={`relative bg-zinc-950 border border-zinc-800/80 rounded-[2rem] w-full max-w-5xl shadow-2xl overflow-hidden flex flex-col md:flex-row max-h-[96vh] modal-content ${loading ? 'opacity-90 grayscale-[0.3]' : 'opacity-100'}`}>
                    ...
                    <div className="flex flex-col items-center w-full space-y-10 relative z-10">
                        <div className="flex flex-col items-center gap-6">
                            <div className="relative">
                                <div className="w-20 h-20 rounded-2xl bg-orange-500/10 flex items-center justify-center border border-orange-500/20 shadow-[0_0_30px_rgba(249,115,22,0.1)]">
                                    <Box size={40} className="text-orange-500" strokeWidth={1.5} />
                                </div>
                                <div className="absolute -bottom-2 -right-2 bg-zinc-900 rounded-lg px-2 py-1 border border-zinc-800 flex items-center gap-1.5 shadow-xl">
                                    <div className="w-1.5 h-1.5 rounded-full bg-orange-500 animate-pulse" />
                                    <span className="text-[10px] font-bold text-zinc-300 uppercase tracking-wider">BOX</span>
                                </div>
                            </div>
                        ...
                        <div className="bg-zinc-950/50 border border-zinc-800 rounded-2xl p-6 relative z-10">
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-[10px] font-bold text-orange-500/60 uppercase tracking-wider">Valor Estimado</span>
                            </div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <UnifiedInput
                                    ...
                                    onChange={v => updateForm('currentStock', v)}
                                />
                                <UnifiedInput
                                    label="Unidade"
                                    type="select"
                    ...
                    <section className="space-y-5">
                        ...
                        <div className="w-1/2 pr-6">
                            <UnifiedInput
                                ...
                                type="number"
                                value={form.minStock}
                                onChange={v => updateForm('minStock', v)}
                            />
                        </div>
                    </section>
                </div>
