  ...
  return (
    <div className="p-6 rounded-3xl bg-card border border-borda-sutil relative flex flex-col gap-6 shadow-2xl backdrop-blur-3xl group transition-all duration-500">
      ...
      <div className="flex gap-3 overflow-x-hidden pb-4 -mx-2 px-2 min-h-[110px] items-stretch">
        ...
        {insumos.length === 0 && (
          <div className="w-full flex items-center justify-between p-4 px-5 rounded-2xl bg-zinc-100 dark:bg-zinc-950/20 border border-dashed border-borda-sutil relative overflow-hidden group/empty">
            <div className="flex items-center gap-4 relative z-10">
              <div className="w-10 h-10 rounded-xl bg-white dark:bg-white/[0.02] border border-borda-sutil flex items-center justify-center text-zinc-400 dark:text-zinc-600">
                <Package size={16} />
              </div>
              <div className="flex flex-col">
                <span className="text-[10px] font-black uppercase tracking-widest text-zinc-500 dark:text-zinc-400">Estoque Vazio</span>
                <span className="text-[9px] font-bold text-zinc-400 dark:text-zinc-600 uppercase leading-tight">Cadastre insumos para começar</span>
              </div>
            </div>
            <button 
              onClick={abrirNovo}
