      ...
      <div className="p-8 space-y-8">
        ...
        <div className="space-y-6">
           <div className="flex items-center justify-between">
              <h3 className="text-xs font-black text-zinc-400 dark:text-zinc-500 uppercase tracking-[0.2em]">Relação de Ativos</h3>
              <div className="flex items-center gap-2 px-3 py-1 bg-zinc-50 dark:bg-white/5 rounded-full border border-borda-sutil">
           ...
           <div className="max-h-[400px] overflow-y-auto pr-2 space-y-2 custom-scrollbar">
              {(tipoVista === "ambos" || tipoVista === "materiais") && (
                <>
                   <div className="sticky top-0 bg-card/80 backdrop-blur-md py-2 z-10 border-b border-borda-sutil mb-2">
                  ...
                  {materiais.map((m) => {
                    ...
                    return (
                       <motion.div 
                        layout
                        key={m.id}
                        className="flex items-center justify-between p-4 rounded-2xl bg-zinc-50/50 dark:bg-white/[0.02] border border-transparent hover:border-borda-sutil transition-all group"
                      >
                        <div className="flex items-center gap-4">
                           ...
                           <div className="flex flex-col">
                              <span className="text-xs font-black text-primary dark:text-white uppercase tracking-tight">{m.nome}</span>
                              <span className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest">
                        ...
                        <div className="flex flex-col items-end">
                           <span className="text-sm font-black text-primary dark:text-white tracking-tighter">
              ...
              {(tipoVista === "ambos" || tipoVista === "insumos") && (
                <>
                   <div className={`sticky top-0 bg-card/80 backdrop-blur-md py-2 z-10 border-b border-borda-sutil mb-2 ${tipoVista === "ambos" ? "mt-6" : ""}`}>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-4">
                           ...
                           <div className="flex flex-col">
                              <span className="text-xs font-black text-primary dark:text-white uppercase tracking-tight">{i.nome}</span>
                              <span className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest">
