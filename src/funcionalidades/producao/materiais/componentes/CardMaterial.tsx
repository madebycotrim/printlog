  ...
  return (
    ...
    >
      ...
      <div className="absolute top-4 left-4 z-20">
        <span className="px-2.5 py-1 rounded-md text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground bg-muted/60 dark:bg-transparent border border-borda-sutil dark:border-white/5 flex items-center justify-center shadow-sm dark:shadow-none">
      ...
      <div className="absolute top-4 right-4 z-30 flex items-center gap-1.5" ref={referenciaMenu}>
          ...
          <button
            ...
            className={`p-2 rounded-xl transition-all border ${
              material.favorito 
                ...
                : "text-muted-foreground hover:bg-amber-500/10 hover:text-amber-500 border-transparent hover:border-amber-500/20"
            }`}
          >
        ...
        <button
          ...
          className="p-2 rounded-xl text-muted-foreground hover:bg-emerald-500/10 hover:text-emerald-500 transition-all border border-transparent hover:border-emerald-500/20"
        >
          <Scale size={18} />
        </button>
            ...
            {menuAberto && (
              ...
              >
                <button
                  ...
                  className="w-full flex items-center gap-3 px-3 py-2 text-[10px] font-black text-muted-foreground hover:bg-muted hover:text-primary dark:hover:text-white rounded-xl transition-all uppercase tracking-widest"
                >
                  <HistoryIcon size={14} />
                  Ver Histórico
                </button>
                ...
                <div className="h-px bg-borda-sutil/50 my-1" />
      ...
      <div className="px-5 py-5 flex flex-col bg-transparent border-t border-borda-sutil">
        {/* Linha 1: Fabricante e Peso Principal */}
        <div className="flex items-start justify-between mb-2">
          <span className="text-[9px] font-black uppercase tracking-[0.2em] text-muted-foreground mb-1 truncate mr-2">
            {material.fabricante}
          </span>
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex flex-col min-w-0 pr-4">
            <h4 className="text-xl font-black text-primary tracking-tight truncate uppercase leading-none">
              {material.nome}
            </h4>
          </div>

          <div className="flex items-baseline gap-1 shrink-0">
            {material.pesoRestanteGramas < 200 && <HistoryIcon size={14} className="text-rose-500 animate-pulse mr-1" />}
            ...
            <span className="text-[10px] font-black opacity-30 uppercase">{unidade}</span>
          </div>
        </div>
        ...
        <div className="space-y-3 mt-auto">
          <div className="flex items-center justify-between text-[10px] font-black uppercase tracking-widest leading-none">
             ...
             <div className="flex items-center whitespace-nowrap">
               <span className="text-primary tracking-tighter tabular-nums font-black">
          ...
          <div className="relative">
            <div className="h-1.5 w-full bg-muted dark:bg-white/5 rounded-full overflow-hidden relative">
              <motion.div 
                initial={{ width: 0 }}
