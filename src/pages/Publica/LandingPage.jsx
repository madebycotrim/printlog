...
const HeroVisual = () => (
    <div className="relative w-full h-[550px] flex items-center justify-center scale-90 lg:scale-100">
        ...
        {/* CARD CENTRAL: MONITORAMENTO DE IMPRESSÃƒO */}
        <div className="relative z-20 w-[360px] md:w-[400px] bg-[#0c0c0e] border border-sky-500/30 rounded-[3rem] p-10 shadow-[0_0_80px_rgba(0,0,0,0.8)] overflow-hidden">
            ...
            <h4 className="text-white font-black text-3xl italic uppercase mb-10 tracking-tighter leading-none">
                PeÃ§a_Final<span className="text-sky-500">.gcode</span>
            </h4>

            <div className="space-y-5 mb-10">
                {[
                    { icon: Zap, label: "Gasto de Energia", val: "R$ 12,30", color: "text-amber-500", bg: "bg-amber-500/10" },
                    { icon: Clock, label: "Tempo de MÃ¡quina", val: "R$ 2,15", color: "text-sky-500", bg: "bg-sky-500/10" },
            ...
            <div className="pt-8 border-t border-white/5 relative">
                <div className="flex items-center gap-2 mb-2">
                    ...
                    <p className="text-[10px] font-bold text-emerald-500 uppercase tracking-[0.3em]">Dinheiro limpo por peÃ§a</p>
                </div>
...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen bg-[#050506] text-zinc-100 font-sans selection:bg-sky-500/30 overflow-x-hidden relative">
                    ...
                    <div className="space-y-12 text-center lg:text-left">
                        <div className="space-y-6">
                            ...
                            <p className="text-xl text-zinc-500 max-w-lg mx-auto lg:mx-0 font-medium leading-relaxed italic">
                                Pare de precificar no olhÃ´metro. Calcule o custo real de cada bico ligado e gerencie seu estoque com precisÃ£o profissional.
                            </p>
                        </div>
                        <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start">
                            <button onClick={() => setLocation('/register')} className="h-16 px-10 rounded-2xl bg-sky-600 hover:bg-sky-500 text-white font-bold text-[11px] uppercase tracking-[0.2em] flex items-center justify-center gap-3 shadow-xl shadow-sky-500/20">
                                ComeÃ§ar Agora <ArrowRight size={18} strokeWidth={3} />
                            </button>
                            <button onClick={() => setLocation('/preview')} className="h-16 px-10 rounded-2xl bg-[#1a1a1c] border border-white/5 text-white font-bold text-[11px] uppercase tracking-[0.2em] hover:bg-zinc-800 flex items-center justify-center gap-3">
                                <Calculator size={18} /> OrÃ§ar uma PeÃ§a
                            </button>
                        </div>
                    </div>
            ...
            <section className="py-24 px-8 max-w-7xl mx-auto z-10 relative">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8">
                    <GlassCard className="lg:col-span-8">
                        <div className="space-y-6">
                            <Badge icon={Coins} label="PrecificaÃ§Ã£o Inteligente" color="emerald" />
                            ...
                            <p className="text-zinc-500 text-lg max-w-lg">Contabilizamos a luz da sua regiÃ£o, o desgaste da sua mÃ¡quina e atÃ© uma reserva para peÃ§as que dÃ£o errado (warp ou bico entupido).</p>
                        </div>
                        <div className="mt-12 grid grid-cols-3 gap-8 bg-black/40 p-8 rounded-[2rem] border border-white/5 font-bold uppercase italic">
                            ...
                            <div className="border-l border-white/5 pl-8"><p className="text-[10px] text-emerald-500 mb-1">PreÃ§o para Venda</p><p className="text-3xl text-emerald-400">R$ 145,90</p></div>
                        </div>
                    </GlassCard>
                    ...
                    <GlassCard className="lg:col-span-4 flex flex-col justify-between">
                        <div className="space-y-4">
                            ...
                            <p className="text-zinc-500 text-sm font-medium italic">Saiba exatamente se o rolo aguenta o tranco atÃ© o fim da impressÃ£o.</p>
                        </div>
                    ...
                    <GlassCard className="lg:col-span-12 flex flex-col md:flex-row items-center gap-12">
                        <div className="flex-1 space-y-6">
                            ...
                            <h3 className="text-5xl font-black text-white uppercase italic leading-[0.9] tracking-tighter">Mande o orÃ§amento <br /> direto no <span className="text-emerald-500">WhatsApp.</span></h3>
                            <p className="text-zinc-500 text-lg max-w-sm italic">O sistema cria uma mensagem profissional com todos os detalhes tÃ©cnicos para vocÃª mandar pro cliente em um clique.</p>
                        </div>
                        <div className="w-full max-w-[380px] bg-[#0c0c0e] border border-white/5 rounded-[2.5rem] overflow-hidden shadow-2xl">
                            ...
                            <div className="p-6 space-y-4 bg-[#0a0a0c]">
                                <div className="p-5 bg-[#0c0c0e] rounded-xl border border-white/5 font-mono text-[10px] space-y-3 text-zinc-300">
                                    <p className="text-zinc-500">*ORÃ‡AMENTO DE IMPRESSÃƒO 3D*</p>
                                    <p>*PeÃ§a:* Samurai V2 (ResoluÃ§Ã£o 0.12mm)</p>
            ...
            {/* PREVENÃ‡ÃƒO DE PERDAS */}
            <section className="py-32 bg-[#050506] border-y border-white/5 relative z-10 text-center">
                <div className="max-w-7xl mx-auto px-8">
                    <Badge label="Evite prejuÃ­zos" color="rose" icon={ShieldAlert} className="mx-auto" />

                    {/* TÃ­tulo com margem inferior reduzida para o texto vir logo abaixo */}
                    ...
                    <p className="max-w-2xl mx-auto text-zinc-400 text-lg md:text-xl mt-8 mb-8 leading-relaxed font-light">
                        Pequenos desperdÃ­cios escondidos no seu dia a dia estÃ£o matando sua margem de lucro sem vocÃª perceber.
                        Tenha controle total sobre cada grama de filamento e cada minuto de mÃ¡quina ligada.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
                        {[
                            { title: 'PeÃ§as que deram errado', icon: AlertTriangle, desc: 'Calcule o prejuÃ­zo real quando a peÃ§a descola da mesa ou a luz acaba.' },
                            { title: 'Troca de bico e peÃ§as', icon: Wrench, desc: 'Junte uma reserva automÃ¡tica para bicos, correias e lubrificaÃ§Ã£o sem sustos.' },
                            { title: 'Taxas de Venda', icon: ShoppingBag, desc: 'Saiba seu lucro de verdade apÃ³s descontar as taxas de Shopee ou Mercado Livre.' },
                            { title: 'Seu tempo vale ouro', icon: History, desc: 'NÃ£o esqueÃ§a de cobrar pelo tempo que vocÃª gasta fatiando e limpando a peÃ§a.' }
                        ].map((item, i) => (
            ...
            <section className="py-40 px-8 relative z-10 text-center">
                <div className="max-w-4xl mx-auto space-y-14">
                    ...
                    <h2 className="text-6xl md:text-8xl font-black text-white tracking-tighter leading-[0.85] uppercase italic">
                        MENOS CHUTE. <br />
                        <span className="text-zinc-700">MAIS PRODUÃ‡ÃƒO.</span>
                    </h2>

                    {/* TEXTO ADICIONADO ABAIXO */}
                    <p className="max-w-2xl mx-auto text-zinc-400 text-lg md:text-xl leading-relaxed">
                        Abandone as planilhas complexas e as contas de cabeÃ§a. Tenha o controle absoluto de cada grama e cada centavo da sua operaÃ§Ã£o 3D.
                    </p>
            ...
            <footer className="py-20 border-t border-white/5 bg-[#050506] relative z-10">
                <div className="max-w-7xl mx-auto px-8">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-12">
                        ...
                        {/* Centralizado no desktop: Link de contato com Ã­cone */}
