    ...
    <div className="w-80 bg-zinc-950/40 backdrop-blur-xl border border-zinc-800/50 rounded-[2rem] p-6 shadow-2xl">
        <div className="flex justify-between items-start mb-6">
            <div className="space-y-1">
                <Badge label="Em operaÃ§Ã£o" color="emerald" icon={Activity} />
    ...
    <div className="bg-zinc-950/60 backdrop-blur-xl border border-sky-500/20 rounded-[2rem] p-6 shadow-2xl ml-auto -mt-12 mr-[-30px] relative z-20 w-72">
        <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex flex-col">
                <span className="text-[9px] font-bold text-sky-500 uppercase">ProduÃ§Ã£o do MÃªs</span>
                <span className="text-[11px] font-bold text-white uppercase">PeÃ§as Prontas</span>
            </div>
        </div>
    ...
    const handlePasswordSignIn = async (e) => {
        ...
        try {
            ...
            if (result.status === "complete") {
                ...
                setError('CÃ³digo de verificaÃ§Ã£o necessÃ¡rio. Verifique seu email ou autenticador.');
            } else {
    ...
    const handleMagicLinkSignIn = async (e) => {
        ...
        try {
            ...
            if (emailCodeFactor) {
                ...
                setError("O login por link nÃ£o estÃ¡ disponÃ­vel para este e-mail.");
            }
        } catch (err) {
            handleClerkError(err);
            setIsSent(false);
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="text-center">
                                    ...
                                    >
                                        ...
                                        {loginMode === 'magic' ? "Entrar com e-mail e senha" : "Entrar sem senha (Link RÃ¡pido)"}
                                    </button>
                                </div>
                            </div>
                        </form>
                        ...
                        <div className="bg-sky-500/5 border border-sky-500/20 rounded-[2.5rem] p-10 text-center space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-zinc-400 text-sm">
                                    DÃª uma olhada na sua caixa de entrada. Enviamos um link para: <br />
