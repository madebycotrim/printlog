    ...
    <div className="space-y-6">
        <section className="space-y-2">
            <h4 className="text-white font-black text-xs uppercase tracking-widest flex items-center gap-2">
                ...
                1. O que Ã© o PrintLog
            </h4>
            <p className="text-xs text-zinc-500 leading-relaxed">
                O PrintLog Ã© um sistema de gestÃ£o feito para makers e donos de
                oficinas de impressÃ£o 3D que precisam organizar custos, processos e o histÃ³rico
                de produÃ§Ã£o.
            </p>
        </section>
        <section className="space-y-2">
            <h4 className="text-white font-black text-xs uppercase tracking-widest flex items-center gap-2">
                ...
                2. Melhorias e EvoluÃ§Ã£o
            </h4>
            <p className="text-xs text-zinc-500 leading-relaxed">
                O PrintLog estÃ¡ sempre recebendo atualizaÃ§Ãµes. Podemos ajustar ou criar
                novas funÃ§Ãµes para deixar o sistema mais Ãºtil para a sua produÃ§Ã£o.
            </p>
        </section>
        <section className="space-y-2">
            <h4 className="text-white font-black text-xs uppercase tracking-widest flex items-center gap-2">
            ...
            <p className="text-xs text-zinc-500 leading-relaxed">
                O uso deve ser manual e focado na gestÃ£o da sua oficina. Comportamentos abusivos podem gerar suspensÃ£o.
            </p>
        </section>
    </div>
);
...
const PRIVACY_CONTENT = (
    <div className="space-y-6">
        <div className="flex items-center gap-3 p-4 bg-emerald-500/5 border border-emerald-500/10 rounded-2xl">
            ...
            <div>
                <p className="text-[10px] text-emerald-500 font-black uppercase tracking-widest">SeguranÃ§a em primeiro lugar</p>
        ...
        <section className="space-y-2">
            ...
            <p className="text-xs text-zinc-500 leading-relaxed">
                Seus custos e margens de lucro sÃ£o protegidos com criptografia antes de entrarem no nosso banco de dados.
            </p>
        </section>
        <section className="space-y-2">
            <h4 className="text-white font-black text-xs uppercase tracking-widest flex items-center gap-2">
                <EyeOff size={14} className="text-sky-500" />
                2. Seus dados sÃ£o sÃ³ seus
            </h4>
            <p className="text-xs text-zinc-500 leading-relaxed">
                O PrintLog nÃ£o vende e nÃ£o repassa seus dados para ninguÃ©m.
            </p>
        </section>
    </div>
);
...
export default function RegisterPage() {
    ...
    const handlePasswordSignUp = async (e) => {
        ...
        setError("");
        try {
            // Sincroniza o Nome do usuÃ¡rio com o firstName do Clerk
            await signUp.create({
                emailAddress: email,
                password,
                firstName: name
                ...
                <div className="w-full max-w-md space-y-10">
                    ...
                    {!isSent && !pendingVerification ? (
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="text-center">
                                    ...
                                    >
                                        ...
                                        {regMode === 'magic' ? "Entrar com e-mail e senha" : "Cadastrar sem senha (Link RÃ¡pido)"}
                                    </button>
                                </div>
                            </div>
                        </form>
                        ...
                        <form onSubmit={handleVerifyCode} className="space-y-6">
                            <div className="space-y-4 text-center bg-sky-500/5 border border-sky-500/20 p-8 rounded-[2rem]">
                                <label className="text-xs font-bold uppercase text-sky-500 block">CÃ³digo de ConfirmaÃ§Ã£o</label>
                                <input
                                    ...
                                    placeholder="000000"
                                />
                                <p className="text-[11px] text-zinc-500 font-medium">Confira o cÃ³digo que chegou no seu e-mail.</p>
                            </div>
                        ...
                        <div className="bg-sky-500/5 border border-sky-500/20 rounded-[2.5rem] p-10 text-center space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-zinc-400 text-sm">DÃª uma olhada na sua caixa de entrada em <strong>{email}</strong> para ativar sua oficina.</p>
                            </div>
                            <button onClick={() => setIsSent(false)} className="text-zinc-500 text-xs font-bold uppercase hover:text-white">â† Tentar outro e-mail</button>
                        </div>
                    )}
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-[10px] text-zinc-600 leading-relaxed uppercase tracking-wider max-w-[280px] mx-auto text-center">
                            Ao criar sua conta, vocÃª concorda com nossos <br />
                            <button
                            ...
                            {' '} e {' '}
                            <button
                                onClick={() => setModal({ isOpen: true, title: 'PolÃ­tica de Privacidade', content: PRIVACY_CONTENT })}
                                className="text-zinc-400 hover:text-sky-500 underline decoration-zinc-800 underline-offset-4"
                            >
                                Privacidade
                            </button>.
