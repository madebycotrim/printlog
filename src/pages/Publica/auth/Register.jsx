...
export default function RegisterPage() {
    ...
    const handlePasswordSignUp = async (e) => {
        ...
        if (!isValidEmail(email)) {
            setError("E-mail inv�lido. Verifique o endere�o digitado.");
            return;
        }
                ...
                <div className="w-full max-w-md space-y-10">
                    <div className="space-y-4 text-center sm:text-left">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-zinc-500 text-sm font-medium">
                                Junte-se a outros makers e organize sua produ��o 3D.
                            </p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handlePasswordSignUp} className="space-y-5">
                        ...
                        <div className="flex items-start gap-3 px-1 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
                            ...
                            <label htmlFor="terms" className="text-xs text-zinc-500 leading-relaxed cursor-pointer select-none hover:text-zinc-300 transition-colors">
                                Li e concordo com os <a href="/terms-of-service" target="_blank" className="text-sky-500 hover:text-sky-400 hover:underline font-bold">Termos de Uso</a> e a <a href="/privacy-policy" target="_blank" className="text-sky-500 hover:text-sky-400 hover:underline font-bold">Pol�tica de Privacidade</a> do PrintLog.
                            </label>
                        </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-center text-zinc-500 text-sm">
                            J� tem acesso? <button onClick={() => setLocation('/login')} className="text-sky-500 font-bold hover:text-sky-400 ml-2">Entrar agora</button>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="hidden lg:flex flex-1 bg-zinc-950/40 border-l border-white/5 relative items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 scale-110">
                    ...
                    <div className="bg-zinc-950/60 backdrop-blur-xl border border-sky-500/20 rounded-[2rem] p-6 shadow-2xl ml-auto -mt-12 mr-[-40px] relative z-20 w-64 text-center hover:scale-105 transition-transform duration-500">
                        ...
                        <span className="text-[11px] text-zinc-500 block mt-1">Tudo o que voc� precisa em uma �nica tela</span>
                    </div>
