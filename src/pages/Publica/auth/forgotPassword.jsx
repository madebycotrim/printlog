    ...
    <div className="w-80 bg-[#0c0c0e]/80 backdrop-blur-xl border border-white/10 rounded-[2rem] p-6 shadow-2xl">
        <div className="flex justify-between items-start mb-6">
            <div className="space-y-1">
                <Badge label="SeguranÃ§a" color="amber" icon={Settings} />
...
export default function ForgotPasswordPage() {
    ...
    const handleSendCode = async (e) => {
        ...
        try {
            ...
            setError(err.errors?.[0]?.longMessage || "NÃ£o encontramos esse e-mail na nossa base.");
        } finally {
            setIsLoading(false);
        }
    };

    // 2. Validar cÃ³digo e definir nova senha
    const handleResetPassword = async (e) => {
        ...
        try {
            ...
            if (result.status === "complete") {
                // Ao finalizar, criamos a sessÃ£o e jogamos para o Dashboard
            ...
            setError(err.errors?.[0]?.longMessage || "CÃ³digo incorreto ou senha muito curta.");
        } finally {
            setIsLoading(false);
        }
    };
                        ...
                        {step === 1 ? (
                            <div className="space-y-5">
                                ...
                                <PrimaryButton type="submit" variant="sky" className="w-full" isLoading={isLoading} icon={Zap}>
                                    Receber cÃ³digo de acesso
                                </PrimaryButton>
                            </div>
                        ) : (
                            <div className="space-y-6">
                                <div className="space-y-4 text-center bg-sky-500/5 border border-sky-500/20 p-8 rounded-[2rem]">
                                    <label className="text-xs font-bold uppercase tracking-widest text-sky-500 block">Digite o cÃ³digo do e-mail</label>
                                    <input
                    ...
                    <div className="bg-[#0c0c0e]/90 backdrop-blur-xl border border-sky-500/20 rounded-[2rem] p-6 shadow-2xl mt-6 mx-auto w-72">
                        <div className="flex items-center gap-4 mb-3">
                            ...
                            <div className="text-left">
                                <span className="text-[10px] font-bold uppercase text-emerald-500 block">ProteÃ§Ã£o Maker</span>
                        ...
                        <p className="text-[10px] text-zinc-500 text-left leading-relaxed uppercase font-bold opacity-60">
                            Sua conta estÃ¡ segura com criptografia de ponta a ponta.
                        </p>
                    </div>
