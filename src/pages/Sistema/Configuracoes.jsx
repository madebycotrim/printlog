                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
                            ...
                            <div className="lg:row-span-2 h-full">
                                <CartaoInformativo titulo="Minha Foto" subtitulo="Imagem do Perfil" Icone={User} classeCor="sky" etiqueta="UsuÃ¡rio" className="h-full">
                            ...
                            {/* CONTROLE DE SENHA */}
                            <CartaoInformativo titulo="Senha de Acesso" subtitulo="SeguranÃ§a da Conta" Icone={Lock} classeCor="emerald" etiqueta="Privado">
                            ...
                            <CartaoInformativo titulo="Baixar Dados" subtitulo="RelatÃ³rios e Planilhas" Icone={HardDrive} classeCor="sky" etiqueta="Backup">
                                ...
                                <div className="grid grid-cols-1 gap-3">
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-xs font-black text-sky-500 uppercase tracking-wide transition-colors">Documento TÃ©cnico (PDF)</span>
                                        </div>
                            ...
                            {/* ZONA DE EXCLUSÃƒO (RodapÃ© direito - Ocupa 2 colunas) */}
                            <div className="lg:col-span-2">
                                <CartaoInformativo titulo="Excluir Conta" subtitulo="Zona de Perigo" Icone={Trash2} classeCor="rose" etiqueta="IrreversÃ­vel">
                                    <p className="text-xs text-zinc-500 mb-4 leading-relaxed font-medium">
                                        Perda irreversÃ­vel de todos os dados.
                                    </p>
                    ...
                    <div className="mt-8 p-6 rounded-2xl bg-gradient-to-br from-zinc-900/50 to-zinc-900/20 border border-zinc-800/50 flex flex-col md:flex-row items-center justify-between gap-6 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-wider mt-0.5">Nossa equipe pode ajudar com dÃºvidas especÃ­ficas.</p>
                            </div>
                        </div>
            ...
            >
                <div className="space-y-4">
                    ...
                    <div className="space-y-3 p-4 bg-zinc-900/50 rounded-xl border border-zinc-800">
                        ...
                        <div className="space-y-2">
                            {[
                                { test: logica.requisitosSenha.tamanhoMinimo, label: "MÃ­nimo de 8 caracteres" },
                                { test: logica.requisitosSenha.temMaiuscula, label: "Pelo menos 1 letra maiÃºscula (A-Z)" },
                                { test: logica.requisitosSenha.temMinuscula, label: "Pelo menos 1 letra minÃºscula (a-z)" },
                                { test: logica.requisitosSenha.temNumero, label: "Pelo menos 1 nÃºmero (0-9)" },
                    ...
                    {logica.formularioSenha.novaSenha.length > 0 && (
                        <div className="space-y-2 p-4 bg-zinc-950/40/30 rounded-xl border border-zinc-800/50">
                            <div className="flex items-center justify-between">
                                <span className="text-xs font-black text-zinc-500 uppercase tracking-wider">ForÃ§a da senha</span>
            ...
            >
                <div className="space-y-4">
                    <p className="text-sm text-zinc-300 leading-relaxed">
                        VocÃª estÃ¡ prestes a <strong className="text-rose-400 font-black">excluir permanentemente</strong> sua conta e todos os dados associados:
                    </p>
                    ...
                    <ul className="space-y-2 pl-4">
                        ...
                        <li className="text-xs text-zinc-400 flex items-start gap-2">
                            <span className="text-rose-500 mt-0.5">â€¢</span>
                            <span>HistÃ³rico completo de projetos</span>
                        </li>
                        <li className="text-xs text-zinc-400 flex items-start gap-2">
                            <span className="text-rose-500 mt-0.5">â€¢</span>
                            <span>ConfiguraÃ§Ãµes e preferÃªncias</span>
                        </li>
                    </ul>

                    <div className="p-4 bg-rose-500/10 border border-rose-500/30 rounded-xl">
                        <p className="text-xs text-rose-300 font-bold text-center">
                            âš ï¸ Esta aÃ§Ã£o nÃ£o pode ser desfeita. Os dados nÃ£o poderÃ£o ser recuperados.
                        </p>
                    </div>
                </div>
            </Popup >
