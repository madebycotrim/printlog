...
export default function SSOCallback() {
    ...
    return (
        <div className="min-h-screen bg-[#050506] flex flex-col items-center justify-center p-6 overflow-hidden relative">
            ...
            {/* ELEMENTOS VISUAIS DE FUNDO (Ajustados para responsividade) */}
            ...
            <div className="relative z-10 flex flex-col items-center w-full max-w-xs sm:max-w-sm">
                ...
                {/* LOADER ANIMADO (Escala mantida, mas centralizada) */}
                ...
                {/* TEXTOS (Tracking ajustado para telas menores) */}
                <div className="text-center space-y-3 mb-10 sm:mb-12">
                    ...
                    <p className="text-zinc-600 text-[9px] sm:text-[10px] font-bold uppercase tracking-widest animate-pulse">
                        Validando protocolo de acesso...
                    </p>
                </div>

                {/* BOTÃO DE CANCELAR (Mais fácil de clicar no mobile) */}
                <button 
            ...
            {/* DECORAÇÃO TÉCNICA (Opcional, apenas para preencher o vazio em telas maiores) */}
            <div className="absolute bottom-10 left-10 opacity-5 hidden sm:block">
                <div className="font-mono text-[8px] text-sky-500 space-y-1 uppercase">
                    <p>Auth_Token: 0x82...F2</p>
                    <p>Status: Handshake_Pending</p>
                </div>
            </div>
        </div>
    );
