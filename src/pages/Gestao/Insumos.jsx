...
export default function InsumosPage() {
    ...
    // DefiniÃ§Ã£o das Categorias com Ãcones
    const CATEGORIES = [
        { id: 'Todos', label: 'Geral', icon: Layers },
        { id: 'Embalagem', label: 'Embalagens', icon: Box },
        { id: 'FixaÃ§Ã£o', label: 'FixaÃ§Ã£o', icon: Link },
        { id: 'EletrÃ´nica', label: 'EletrÃ´nica', icon: Zap },
    ...
    // LÃ“GICA DE ESTATÃSTICAS E FILTRAGEM
            ...
            >
                ...
                <div className="relative z-10 p-8 xl:p-12 max-w-[1600px] mx-auto w-full">
                    ...
                    <div className="space-y-8">
                        ...
                        {/* ABAS DE NAVEGAÃ‡ÃƒO POR CATEGORIA */}
                ...
                >
                    <div className="p-8 text-center space-y-4">
                        <p className="text-zinc-400 text-sm font-medium leading-relaxed">
                            VocÃª estÃ¡ prestes a remover permanentemente o insumo <br />
