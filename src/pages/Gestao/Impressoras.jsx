            ...
            try {
                ...
                const novoHistorico = {
                    ...
                    descricao: acoesRealizadas.length > 0
                        ? `DiagnÃ³stico: ${acoesRealizadas.join(', ')}`
                        : "ManutenÃ§Ã£o Preventiva de Rotina",
                    custo: 0,
                ...
                setToast({ visible: true, message: "ManutenÃ§Ã£o finalizada!", type: 'success' });
            } catch (_erro) {
                setToast({ visible: true, message: "Erro ao finalizar manutenÃ§Ã£o.", type: 'error' });
            }
        }
                ...
                <Popup
                    ...
                    footer={
                        <div className="flex gap-3 w-full">
                            ...
                            >
                                <Trash2 size={16} /> Confirmar RemoÃ§Ã£o
                            </button>
                        </div>
                    }
                >
                    <div className="p-8 text-center space-y-4">
                        <p className="text-zinc-400 text-sm font-medium leading-relaxed">
                            VocÃª estÃ¡ prestes a remover a impressora <br />
                        ...
                        <div className="p-4 rounded-2xl bg-rose-500/5 border border-rose-500/10">
                            <p className="text-[10px] text-rose-500/80 font-black uppercase tracking-widest leading-tight">
                                AtenÃ§Ã£o: Os dados de horas trabalhadas e o histÃ³rico de impressÃµes deste hardware serÃ£o desconectados da sua conta.
                            </p>
                        </div>
                    </div>
                </Popup>
