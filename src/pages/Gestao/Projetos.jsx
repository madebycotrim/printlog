                        ...
                        <div className="flex items-start justify-between flex-wrap gap-4">
                            <div>
                                ...
                                <p className="text-sm text-zinc-500 capitalize">
                                    Gesṭo de Propostas Comerciais
                                </p>
                            </div>
                            ...
                            <div className="w-full py-24 flex flex-col items-center justify-center border border-dashed border-zinc-800/60 rounded-[3rem] bg-zinc-950/40/5 backdrop-blur-sm">
                                {termoBusca ? (
                                    <div className="flex flex-col items-center text-center">
                                        ...
                                        <p className="text-zinc-600 text-[10px] uppercase mt-3 tracking-widest italic">Crit̩rio: "{termoBusca}"</p>
                                        <button
                                            onClick={() => setTermoBusca("")}
                                    ...
                                    <div className="flex flex-col items-center">
                                        ...
                                        <h3 className="text-zinc-300 text-[11px] font-black uppercase tracking-[0.3em]">Nenhum or̤amento ainda</h3>
                                        <p className="text-zinc-600 text-[10px] uppercase mt-3 tracking-widest leading-relaxed text-center">
                                            Seus projetos salvos apareceṛo aqui.
                                        </p>
                                    </div>
                                )}
                            </div>
