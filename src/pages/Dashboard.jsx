    ...
    return (
        <div className="flex h-screen w-full bg-zinc-950 text-zinc-200 font-sans antialiased overflow-hidden">
            ...
            >
                    ...
                    <div className="mb-12 animate-fade-in-up">
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                            ...
                            <div className="flex items-center gap-3 w-full md:w-auto">
                                ...
                                {/* GRUPO DE AÇÕES RÁPIDAS (Novo Projeto, Filamento, Impressora) */}
                                <div className="flex items-center gap-2 bg-zinc-900/50 p-1.5 rounded-2xl border border-zinc-800/50 shadow-sm">
                                    ...
                                    <button
                                        ...
                                        "
                                        title="Criar novo orçamento ou projeto"
                                    >
                                ...
                                <button
                                    ...
                                    title={editMode ? "Salvar e sair do modo de edição" : "Entrar no modo de edição"}
                                ...
                                {editMode && (
                                    <button
                                        ...
                                        aria-label="Resetar para Layout Padrão"
                                    >
                ...
                {/* MODAIS (Renderizados no nível na pagina) */}
                <ModalFilamento
