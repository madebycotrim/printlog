...
import { Activity, LayoutGrid, RotateCcw, EyeOff, Eye, Plus, Check, Box, Printer, Package, Calculator, Layers } from 'lucide-react';
    ...
    const renderWidgetContent = (id) => {
        ...
        switch (id) {
            ...
            case 'resource_summary':
                content = <ResourceSummaryWidget projects={projects} filaments={filaments} />;
                break;
            case 'fleet_summary':
