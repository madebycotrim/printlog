                        ...
                        <div className="flex items-start justify-between flex-wrap gap-4">
                            <div>
                                ...
                                <p className="text-sm text-zinc-500 capitalize">
                                    GestÃ£o de Contatos e HistÃ³rico
                                </p>
                            </div>
                ...
                >
                    <div className="p-8 text-center space-y-4">
                        <p className="text-zinc-400 text-sm font-medium leading-relaxed">
                            VocÃª estÃ¡ prestes a remover o cliente <br />
                        ...
                        <div className="p-4 rounded-2xl bg-rose-500/5 border border-rose-500/10">
                            <p className="text-[10px] text-rose-500/80 font-black uppercase tracking-widest">
                                AtenÃ§Ã£o: O histÃ³rico de projetos deste cliente serÃ¡ desvinculado.
                            </p>
                        </div>
                    </div>
                </Popup>
