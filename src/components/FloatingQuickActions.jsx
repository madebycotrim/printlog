...
export default function QuickActionsDock({
    ...
    useEffect(() => {
        if (isOpen) {
            // Wait for animation frame or timeout to ensure element is visible/rendered
    ...
    return (
        <>
            ...
            {/* Menu */}
            <div
                className={`fixed bottom-20 right-6 z-[9998] transition-all duration-300 ${isOpen ? 'scale-100 opacity-100' : 'scale-95 opacity-0 pointer-events-none'}`}
                aria-hidden={!isOpen}
            >
                <div
                    ...
                    className="bg-zinc-900/90 backdrop-blur-xl border border-zinc-800 rounded-2xl shadow-2xl p-2 min-w-[200px]"
                >
                    <div className="px-3 py-2 border-b border-zinc-800/50 flex items-center justify-between">
                        ...
                        <button
                            ...
                            className="p-1 hover:bg-zinc-800 rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-sky-500 outline-none"
                        >
                    ...
                    <div className="py-1">
                        {actions.map((action, index) => (
                            <button
                                ...
                                className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-zinc-800/50 transition-colors group focus-visible:ring-2 focus-visible:ring-sky-500 outline-none"
                            >
            ...
            <button
                ...
                className={`fixed bottom-6 right-6 z-[9998] w-12 h-12 rounded-xl flex items-center justify-center transition-all duration-200 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-sky-500 outline-none ${isOpen
