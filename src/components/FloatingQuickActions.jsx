    ...
    return (
        <>
            ...
            <div
                ...
                aria-modal="true"
                aria-hidden={!isOpen}
                className={`fixed bottom-20 right-6 z-[9998] transition-all duration-300 ${isOpen
                ...
                <div className="bg-zinc-900/90 backdrop-blur-xl border border-zinc-800 rounded-2xl shadow-2xl p-2 min-w-[200px]">
                    ...
                    <div className="py-1">
                        {actions.map((action, index) => (
                            ...
                            >
                                <action.icon size={18} aria-hidden="true" className={`${action.color} group-hover:scale-110 transition-transform`} strokeWidth={2} />
