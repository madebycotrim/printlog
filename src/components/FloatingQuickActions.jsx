    ...
    return (
        <>
            ...
            <div
                ...
                className={`fixed bottom-24 right-6 z-[9998] transition-all duration-300 origin-bottom-right ${isOpen ? 'scale-100 opacity-100 translate-y-0' : 'scale-95 opacity-0 pointer-events-none translate-y-4'
                }`}
            >
                <div className="bg-zinc-900/90 backdrop-blur-xl border border-zinc-800 rounded-2xl shadow-2xl p-2 min-w-[200px]">
                    <div className="px-3 py-2 border-b border-zinc-800/50 flex items-center justify-between">
                        <span id={titleId} className="text-xs font-bold text-zinc-500 uppercase tracking-wider">Ações Rápidas</span>
                        <button
                            onClick={() => setIsOpen(false)}
