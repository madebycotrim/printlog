...
// 2. ITEM DA SIDEBAR (FOCO NA COR LATERAL)
    ...
    return (
        <Link href={href}>
            <div className={`relative group cursor-pointer my-1 transition-all duration-300 ${collapsed ? "px-0 flex justify-center" : "px-3"}`}>
                ...
                {/* --- A CORZINHA DA LATERAL (INDICADOR ATIVO) --- */}
                {!collapsed && isActive && (
...
// ... (mantenha os imports e os componentes SidebarItem/SidebarSection como estão)
    ...
    return (
        <aside className={`fixed left-0 top-0 h-screen bg-[#050505] border-r border-zinc-900 z-[1000] flex flex-col transition-all duration-300 ${collapsed ? "w-[72px]" : "w-64"}`}>
            ...
            <div className="p-3 mt-auto">
                <div 
                    // Se estiver encolhido, clicar no bloco todo redireciona para "/"
                    onClick={collapsed ? () => setLocation("/") : undefined}
                    className={`
                ...
                >
                    ...
                    <div className="relative shrink-0">
                        ...
                        `}>
                            <img 
                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSseB6uZeeMH55OlfcMvLSB_O1j4c9eCKFcLQ&s" 
                    ...
                    {/* INFO E BOTÃO (APENAS EXPANDIDO) */}
                    {!collapsed && (
                        <>
                            <div className="flex-1 min-w-0">
                                <p className="text-[11px] font-black text-zinc-200 truncate uppercase tracking-wider">Mateus Cotrim</p>
                    ...
                    {/* TOOLTIP DE LOGOUT (APENAS ENCOLHIDO) */}
                    {collapsed && (
