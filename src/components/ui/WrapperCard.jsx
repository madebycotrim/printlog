...
const WrapperCard = React.memo(({ children, title, step, className = "", zPriority = "z-10", hasNext, subtotal }) => {
    ...
    return (
        <div className={`relative ${zPriority} ${className} mx-2`}>
            <div className={`relative bg-zinc-950/40 border border-zinc-800/50 rounded-2xl p-5 flex flex-col gap-4 group focus-within:z-50 focus-within:border-sky-500/30 hover:border-zinc-800/50/50 hover-lift`}>
